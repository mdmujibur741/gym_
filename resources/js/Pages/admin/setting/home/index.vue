...
function cleanForm(){
    form.reset();
    location.reload();
    toastr.success('Home Data Added Successfully');
} 
    ...
    <section class="bg-gray-200 min-h-[100vh]">
      <div class="min-h-[100vh] justify-center items-center gap-5 p-8">
        <div class="w-full bg-gray-200 p-5 rounded-2xl drop-shadow-2xl mx-auto">
          <div v-if="home.data.length > 0" class="p-6">
            <div v-for="hom in home.data" :key="hom.id">
               <div class="flex justify-end">
                <Link :href="route('admin.home.edit',hom.id)" class="bg-blue-600 text-white px-5 py-2 rounded-xl"><i class="fa-solid fa-pen-to-square"></i></Link>
                </div>
              <h3 class="mb-3" style="white-space: pre-line;"><b>Title :-</b> {{ hom.title }}</h3>
              <p class="mb-3"><b> Description:-</b> {{ hom.description }}</p>
              <b>background Image</b>
              <img :src="hom.image" alt="" class="rounded-2xl" />
            </div>
          </div>
          ...
          <div v-else class="p-6">
            ...
            >
              ...
              <div class="mb-3">
                ...
                <textarea v-model="form.title" id="" rows="3" class="w-full rounded-xl">
                </textarea>
